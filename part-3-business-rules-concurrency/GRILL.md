# GRILL.md — Part 3: Bidding business rules and concurrency

This document carries forward the agreed Part 2 product rules and records the Part 3
concurrency design as it is grilled. Part 3 decisions remain pending until the grilling
session is complete and explicitly confirmed.
...
Both confirmed slices are implemented and verified.
